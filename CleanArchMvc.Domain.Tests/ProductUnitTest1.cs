...
namespace CleanArchMvc.Domain.Tests
{
    public class ProductUnitTest1
    {
        ...
        {
            Action action = () => new Product(1, "Product Name", "Product Description", 9.99m, 99, "product-image.png");
        ...
        {
            Action action = () => new Product(1, "Pr", "Product Description", 9.99m, 99, "product-image.png");
            action.Should()
                 .Throw<CleanArchMvc.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new Product(1, "Product Name", "Product Description", 9.99m, stock, "product-image.png");
            action.Should()
                 .Throw<CleanArchMvc.Domain.Validation.DomainExceptionValidation>()
